...
![alt text](https://github.com/KaneMcGrath/KaneCode/blob/master/Icons/Capture.png "Main interface")

![alt text](https://github.com/KaneMcGrath/KaneCode/blob/master/Icons/Powershell.png "Integrated Powershell running codex")
