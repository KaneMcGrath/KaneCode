...
The goal is to build tools around how I program, and to try out custom tools and llms in patterns I haven't seen elsewhere.

Plans include:
 - A standard IDE with a code editor, file explorer, and build tools.
 - Hotkey system for for modifier + single key language primitives
