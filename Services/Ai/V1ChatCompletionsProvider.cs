...
/// <summary>
/// Modern AI provider that talks to an OpenAI-compatible <c>/v1/chat/completions</c>
/// endpoint with optional SSE streaming and an optional API key.
/// This provider supports the chat completions format including multi-modal inputs
/// (images, audio) and advanced features such as structured outputs and tool calling.
/// </summary>
internal sealed class V1ChatCompletionsProvider : IAiProvider, IDisposable
{
    private readonly HttpClient _httpClient = new() { Timeout = TimeSpan.FromMinutes(5) };
    private readonly AiProviderSettings _settings;
    private IReadOnlyList<string> _availableModels;

    public V1ChatCompletionsProvider(AiProviderSettings settings)
    {
